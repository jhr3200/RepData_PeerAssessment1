...
Now by plotting these two data frames, **weekend{}**, **weekdays{}** the difference between them can be clearly seen. The activity during the weekdays is more frequent and on average has a higher intensity than the weekend. however the weekend activity experiences greater excursions from the mean, possibly indicating periods of exercise.
