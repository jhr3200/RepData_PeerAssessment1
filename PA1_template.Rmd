...
```{r hist_witNA,echo=TRUE,fig.path="figures/"}
...
```{r meandailystep,echo=TRUE,fig.path="figures/"}
...
```{r Hist_noNA,echo=TRUE,fig.path="figures/"}
...
```{r wkday_Wkend,echo=TRUE,fig.path="figures/"}
